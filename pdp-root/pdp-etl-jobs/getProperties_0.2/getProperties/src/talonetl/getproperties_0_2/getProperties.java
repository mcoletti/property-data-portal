...
//
// ============================================================================
package talonetl.getproperties_0_2;
...
public class getProperties implements TalendJob {
	...
	public static class mainPropertyDataLoadStruct implements
			routines.system.IPersistableRow<mainPropertyDataLoadStruct> {
	...
	public static class mappedDataStruct implements
			routines.system.IPersistableRow<mappedDataStruct> {
		final static byte[] commonByteArrayLock_TALONETL_getProperties = new byte[0];
		static byte[] commonByteArray_TALONETL_getProperties = new byte[0];
	...
	public static class loadNewStateInfoStruct implements
			routines.system.IPersistableRow<loadNewStateInfoStruct> {
		final static byte[] commonByteArrayLock_TALONETL_getProperties = new byte[0];
		static byte[] commonByteArray_TALONETL_getProperties = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<row6Struct> tHash_Lookup_Cache_row6 = org.talend.designer.components.lookup.memory.AdvancedMemoryLookup
						.<row6Struct> getLookup(org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH);
				...
				while (it_tFileInputXML_1.hasNext()) {
					...
					if (row1 != null) {
						...
						if (stateInfo != null) {
							...
							long year1_tMysqlOutput_4 = calendar_tMysqlOutput_4
									.getTime().getTime();
							...
							if (null != dataSources_tMysqlOutput_4) {
								conn_tMysqlOutput_4 = dataSources_tMysqlOutput_4
										.get("").getConnection();
							} else {
								...
								if (dbProperties_tMysqlOutput_4 == null
										|| dbProperties_tMysqlOutput_4.trim()
												.length() == 0) {
								...
								conn_tMysqlOutput_4 = java.sql.DriverManager
										.getConnection(url_tMysqlOutput_4,
												dbUser_tMysqlOutput_4,
									...
									if (loadNewStateInfo != null) {
										...
										if (loadNewStateInfo.CITY == null) {
											...
											pstmt_tMysqlOutput_4.setString(3,
													loadNewStateInfo.CITY);
										}

										pstmt_tMysqlOutput_4.setInt(4,
												loadNewStateInfo.ZIP);
							...
							globalMap.put("tMysqlOutput_4_NB_LINE",
									nb_line_tMysqlOutput_4);
										...
										if (mainPropertyDataLoad != null) {
											...
											if (mainPropertyDataLoad.PROP_NAME == null) {
												...
												pstmt_tMysqlOutput_1
														.setString(
																3,
																mainPropertyDataLoad.PROP_NAME);
											}

											pstmt_tMysqlOutput_1.setFloat(4,
													mainPropertyDataLoad.PRICE);
											...
											if (mainPropertyDataLoad.DESCRIPTION == null) {
												...
												pstmt_tMysqlOutput_1
														.setString(
																6,
																mainPropertyDataLoad.DESCRIPTION);
											}

											pstmt_tMysqlOutput_1
													.setFloat(
															7,
															mainPropertyDataLoad.NUM_BEDS);

											pstmt_tMysqlOutput_1
													.setFloat(
															8,
															mainPropertyDataLoad.NUM_BATHS);
											...
											if (mainPropertyDataLoad.STATUS == null) {
												...
												pstmt_tMysqlOutput_1
														.setString(
																10,
																mainPropertyDataLoad.STATUS);
											}

											pstmt_tMysqlOutput_1
													.setInt(11,
															mainPropertyDataLoad.STATE_INFO_ID);

											pstmt_tMysqlOutput_1
													.setInt(12,
															mainPropertyDataLoad.DATA_SOURCE_ID);
				...
				while (rs_tMysqlInput_5.next()) {
					...
					if (colQtyInRs_tMysqlInput_5 < 11) {
						...
						if (rs_tMysqlInput_5.getObject(11) != null) {
							getCurrentProperties.STATE_INFO_ID = rs_tMysqlInput_5
									.getInt(11);
						} else {
							throw new RuntimeException(
									"Null value in non-Nullable column");
		...
		try {
			...
			java.io.InputStream inContext = getProperties.class
					.getClassLoader().getResourceAsStream(
							"talonetl/getproperties_0_2/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 379997 characters generated by Talend Open Studio for Data Integration on the
