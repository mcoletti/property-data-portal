...
/** 
 * This class represents the primary key of the RAW_DATA table.
 */
public class RawDataPk implements Serializable
{
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof RawDataPk)) {
			return false;
		}
		
		final RawDataPk _cast = (RawDataPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.codeitek.pdp.model.RawDataPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
