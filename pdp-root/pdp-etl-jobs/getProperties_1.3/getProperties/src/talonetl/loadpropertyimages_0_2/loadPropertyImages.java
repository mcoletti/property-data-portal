...
public class loadPropertyImages implements TalendJob {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String message = String.format(
						"*** New Image Added for:%s Image:%s ***",
						context.propertyUUId, context.propertyImage);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			context.propertyImage = (String) context
					.getProperty("propertyImage");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("propertyImage")) {
				context.propertyImage = (String) parentContextMap
						.get("propertyImage");
			}
