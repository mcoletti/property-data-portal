...
//
// ============================================================================
package talonetl.getproperties_1_3;
...
public class getProperties implements TalendJob {
	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (customerUUid != null) {
				...
				this.setProperty("customerUUid", customerUUid.toString());
	...
	public static class loadCityDataStruct implements
			routines.system.IPersistableRow<loadCityDataStruct> {
		final static byte[] commonByteArrayLock_TALONETL_getProperties = new byte[0];
		static byte[] commonByteArray_TALONETL_getProperties = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final loadCityDataStruct other = (loadCityDataStruct) obj;
		...
		public void copyDataTo(loadCityDataStruct other) {
		...
		public void copyKeysDataTo(loadCityDataStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(loadCityDataStruct other) {
	...
	public static class loadPropertyDataStruct implements
			routines.system.IPersistableRow<loadPropertyDataStruct> {
		final static byte[] commonByteArrayLock_TALONETL_getProperties = new byte[0];
		static byte[] commonByteArray_TALONETL_getProperties = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final loadPropertyDataStruct other = (loadPropertyDataStruct) obj;
		...
		public void copyDataTo(loadPropertyDataStruct other) {
		...
		public void copyKeysDataTo(loadPropertyDataStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(loadPropertyDataStruct other) {
	...
	public static class propertyDataStruct implements
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALONETL_getProperties) {
				...
				try {
					...
					this.customerUUId = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.customerUUId, dos);
		...
		public String toString() {
			...
			sb.append(",customerUUId=" + customerUUId);
			sb.append("]");
									...
									if (loadPropertyData != null) {
										...
										if (loadPropertyData.PROP_NAME == null) {
											...
											pstmt_tMysqlOutput_1.setString(3,
													loadPropertyData.PROP_NAME);
										}

										pstmt_tMysqlOutput_1.setFloat(4,
												loadPropertyData.PRICE);

										pstmt_tMysqlOutput_1.setFloat(5,
												loadPropertyData.SQFT);
										...
										if (loadPropertyData.DESCRIPTION == null) {
											...
											pstmt_tMysqlOutput_1
													.setString(
															6,
															loadPropertyData.DESCRIPTION);
										}

										pstmt_tMysqlOutput_1.setFloat(7,
												loadPropertyData.NUM_BEDS);

										pstmt_tMysqlOutput_1.setFloat(8,
												loadPropertyData.NUM_BATHS);
										...
										if (loadPropertyData.STATUS == null) {
											...
											pstmt_tMysqlOutput_1.setString(10,
													loadPropertyData.STATUS);
										}

										pstmt_tMysqlOutput_1
												.setInt(11,
														loadPropertyData.DATA_SOURCE_ID);

										pstmt_tMysqlOutput_1.setInt(12,
												loadPropertyData.ZIP_CODE);
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (osName_tRunJob_1 != null
					...
					paraList_tRunJob_1
							.add("talonetl.getpropfinacials_0_3.getPropFinacials");
				...
				parentContextMap_tRunJob_1.put("customerUUid",
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_2.put("customerUUid",
						context.customerUUid);
				...
				while (rs_tMysqlInput_5.next()) {
					...
					if (colQtyInRs_tMysqlInput_5 < 5) {
						...
						if (rs_tMysqlInput_5.getObject(5) != null) {
							getCurrentProperties.SQFT = rs_tMysqlInput_5
									.getFloat(5);
						} else {
							throw new RuntimeException(
									"Null value in non-Nullable column");
	...
	public static class custDataStruct implements
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.CUST_NAME = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.CUST_NAME, dos, oos);
	...
	public void tMysqlInput_11Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_3 - inputs:(row5,row15)
				// outputs:(loadCityData)
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getProperties.class
					.getClassLoader().getResourceAsStream(
							"talonetl/getproperties_1_3/contexts/" + contextStr
									+ ".properties");
			...
			context.customerUUid = (String) context.getProperty("customerUUid");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("customerUUid")) {
				context.customerUUid = (String) parentContextMap
						.get("customerUUid");
			}
...
/************************************************************************************************
 * 500931 characters generated by Talend Open Studio for Data Integration on the
 * June 18, 2013 6:08:19 AM MDT
 ************************************************************************************************/
