...
import com.codeitek.pdp.service.auth.UserSecurityService;
...
public class RESTDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    @Autowired
    public RESTDaoAuthenticationProvider(UserSecurityService userSecurityService, PasswordEncoder passwordEncoder) {
