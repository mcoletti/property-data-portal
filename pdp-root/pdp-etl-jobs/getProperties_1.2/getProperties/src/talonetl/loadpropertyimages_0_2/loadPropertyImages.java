...
public class loadPropertyImages implements TalendJob {
	...
	public static class removeDataStruct implements
			routines.system.IPersistableRow<removeDataStruct> {
		final static byte[] commonByteArrayLock_TALONETL_loadPropertyImages = new byte[0];
		static byte[] commonByteArray_TALONETL_loadPropertyImages = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final removeDataStruct other = (removeDataStruct) obj;
		...
		public void copyDataTo(removeDataStruct other) {
		...
		public void copyKeysDataTo(removeDataStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(removeDataStruct other) {
	...
	public void tMysqlInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				removeDataStruct removeData = new removeDataStruct();
				...
				// ###############################
				// # Outputs initialization
				removeDataStruct removeData_tmp = new removeDataStruct();
				// ###############################
				...
				while (rs_tMysqlInput_3.next()) {
					...
					if (row4 != null) {
						...
						{ // start of Var scope
							...
							// # Output table : 'removeData'
							removeData_tmp.ID = row4.ID;
							removeData_tmp.TITLE = row4.TITLE;
							removeData_tmp.TYPE = null;
							removeData_tmp.SIZE = row4.SIZE;
							removeData_tmp.SRC_URL = row4.SRC_URL;
							removeData_tmp.PROPERTY_DATA_ID = row4.PROPERTY_DATA_ID;
							removeData = removeData_tmp;
							// ###############################
						...
						if (removeData != null) {
							...
							pstmt_tMysqlOutput_2.setInt(1, removeData.ID);
...
/************************************************************************************************
 * 138520 characters generated by Talend Open Studio for Data Integration on the
