...
//
// ============================================================================
package talonetl.getproperties_0_3;
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (osName_tRunJob_2 != null
					...
					paraList_tRunJob_2
							.add("talonetl.loadpropertyimages_0_1.loadPropertyImages");
		...
		try {
			...
			java.io.InputStream inContext = getProperties.class
					.getClassLoader().getResourceAsStream(
							"talonetl/getproperties_0_3/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 391180 characters generated by Talend Open Studio for Data Integration on the
