...
/** 
 * This class represents the primary key of the DATA_SOURCE table.
 */
public class DataSourcePk implements Serializable
{
	 ...
	 * @param id
	 */
	public DataSourcePk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof DataSourcePk)) {
			return false;
		}
		
		final DataSourcePk _cast = (DataSourcePk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.codeitek.pdp.model.DataSourcePk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
