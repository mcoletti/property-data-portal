...
/** 
 * This class represents the primary key of the ROLE_DATA table.
 */
public class RoleDataPk implements Serializable
{
	 ...
	 * @param id
	 */
	public RoleDataPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof RoleDataPk)) {
			return false;
		}
		
		final RoleDataPk _cast = (RoleDataPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.codeitek.pdp.model.RoleDataPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
